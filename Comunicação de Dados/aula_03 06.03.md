...
![backbone](image-3.png)

# EQUIPAMENTOS 

    🢂 placas de rede:
![placa rede](image-6.png)
...
![switchers](image-8.png)

    🢂 roteadores: 
![roteador](image-9.png)

    🢂bridges ("ponte"): conversor de midia, extensor de midia, 
![bridges](image-10.png)

    🢂 repetidores:
![repetidor](image-11.png)
